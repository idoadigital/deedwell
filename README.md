...
This repository contains the **Phase 0 foundation** and the **Phase 2 vertical slice** of the
Deedwell platform: a tenant-isolated, RLS-enforced core with a durable workflow engine, a
tool-gated agent runtime, and one end-to-end grant workflow —
...
- Desktop app (Phase 1), full grant workspace (Phase 3), website platform (Phase 4–5), huddles
  (Phase 6) are **not built** and nothing here pretends they are.
